...
_2025-09-28_: Kayıt konumu ayarlanabiliyor; dosyalar isteğe bağlı seçilen klasöre yazılıyor ve UI konumu gösteriyor (`src/App.tsx`, `src/components/AudioRecorder.tsx`, `src/components/SettingsPage.tsx`, `src/types/fileSystemAccess.d.ts`).
